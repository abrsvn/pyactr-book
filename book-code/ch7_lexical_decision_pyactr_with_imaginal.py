...
#dump('../data/lex_dec_pyactr_with_imaginal', trace)

with lex_decision_with_bayes:
    trace = load('../data/lex_dec_pyactr_with_imaginal')

pm.diagnostics.gelman_rubin(trace)
pm.traceplot(trace)
plt.savefig('../figures/lex_dec_model_pyactr_with_imaginal_trace.eps')
plt.savefig('../figures/lex_dec_model_pyactr_with_imaginal_trace.png')
plt.savefig('../figures/lex_dec_model_pyactr_with_imaginal_trace.pdf')
#plt.show()
...
def generate_lex_dec_pyactr_with_imaginal_figure():
    ...
    plt.savefig('../figures/lex_dec_model_pyactr_with_imaginal.eps')
    plt.savefig('../figures/lex_dec_model_pyactr_with_imaginal.png')
...
plt.savefig('../figures/lex_dec_model_pyactr_with_imaginal_estimates.eps')
plt.savefig('../figures/lex_dec_model_pyactr_with_imaginal_estimates.png')
plt.savefig('../figures/lex_dec_model_pyactr_with_imaginal_estimates.pdf')
#plt.show()
