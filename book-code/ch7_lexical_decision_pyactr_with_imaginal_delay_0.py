...
def generate_lex_dec_pyactr_with_imaginal_delay_0_figure():
    ...
    plt.savefig('../figures/lex_dec_model_pyactr_with_imaginal_delay_0.eps')
    plt.savefig('../figures/lex_dec_model_pyactr_with_imaginal_delay_0.png')
...
plt.savefig('../figures/lex_dec_model_pyactr_with_imaginal_delay_0_estimates.eps')
plt.savefig('../figures/lex_dec_model_pyactr_with_imaginal_delay_0_estimates.png')
plt.savefig('../figures/lex_dec_model_pyactr_with_imaginal_delay_0_estimates.pdf')
#plt.show()
