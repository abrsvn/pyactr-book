...
setup(name='pyactr-book',
      version=VERSION,
      description='ACT-R in Python3, package version and book code for the _Formal Linguistics and Cognitive Architecture_ book by Adrian Brasoveanu and Jakub Dotlacil',
